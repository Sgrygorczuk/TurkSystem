...
and other notifications instead of using postal mail, email, or voicemail.''')
	...
	project0.new_project(client_id = client0.get_id(), bid_id = 0, title = "Turk System", desc = "Random group of four were able to make an awesome project", bid_end_date = now,  deadline = later, status= "actve")
	project1.new_project(client_id = client1.get_id(), bid_id = 1, title = "Hello", desc = "I have a lot of money", bid_end_date = later, deadline = n_days(2), status= "actve")
	project2.new_project(client_id = client2.get_id(), bid_id = 2, title = "World", desc = "I have a lot of money, too?", bid_end_date = later, deadline = n_days(2), status= "actve")
	project3.new_project(client_id = client3.get_id(), bid_id = 3, title = "Goodbye", desc = "I have more money than the other guy", bid_end_date = later, deadline = n_days(2), status= "actve")
	project4.new_project(client_id = client4.get_id(), bid_id = 4, title = "VR", desc = "Don't listen to any of them, I have the most", bid_end_date = later, deadline = n_days(2), status= "actve")
	project5.new_project(client_id = client5.get_id(), bid_id = 5, title = "Cow", desc = "Moo", bid_end_date = later, deadline = n_days(2), status= "actve")

	project6.new_project(client_id = client6.get_id(), bid_id = 6, title = "mack", desc = "I have a lot of money", bid_end_date = later, deadline = n_days(2), status= "actve")
	project7.new_project(client_id = client7.get_id(), bid_id = 7, title = "EM", desc = "I have a lot of money, too?", bid_end_date = later, deadline = n_days(2), status= "actve")
	project8.new_project(client_id = client8.get_id(), bid_id = 8, title = "WE", desc = "I have more money than the other guy", bid_end_date = later, deadline = n_days(2), status= "actve")
	project9.new_project(client_id = client9.get_id(), bid_id = 9, title = "EWW", desc = "Don't listen to any of them, I have the most", bid_end_date = later, deadline = n_days(2), status= "actve")
	project10.new_project(client_id = client10.get_id(), bid_id = 10, title = "Cow", desc = "Moo", bid_end_date = later, deadline = n_days(2), status= "actve")
	
	project11.new_project(client_id = client11.get_id(), bid_id = 11, title = "NO", desc = "I have a lot of money", bid_end_date = later, deadline = n_days(2), status= "actve")
	project12.new_project(client_id = client12.get_id(), bid_id = 12, title = "MORE", desc = "I have a lot of money, too?", bid_end_date = later, deadline = n_days(2), status= "actve")
	project13.new_project(client_id = client13.get_id(), bid_id = 13, title = "PROJECT", desc = "I have more money than the other guy", bid_end_date = later, deadline = n_days(2), status= "actve")
	project14.new_project(client_id = client14.get_id(), bid_id = 14, title = "OR", desc = "Don't listen to any of them, I have the most", bid_end_date = later, deadline = n_days(2), status= "actve")
	project15.new_project(client_id = client15.get_id(), bid_id = 15, title = "Cow", desc = "Moo", bid_end_date = later, deadline = n_days(2), status= "actve")
	
	project16.new_project(client_id = client11.get_id(), bid_id = 16, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project17.new_project(client_id = client11.get_id(), bid_id = 17, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project18.new_project(client_id = client12.get_id(), bid_id = 18, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project19.new_project(client_id = client13.get_id(), bid_id = 19, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project20.new_project(client_id = client14.get_id(), bid_id = 20, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)

	project21.new_project(client_id = client6.get_id(), bid_id = 21, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project22.new_project(client_id = client7.get_id(), bid_id = 22, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project23.new_project(client_id = client8.get_id(), bid_id = 23, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project24.new_project(client_id = client9.get_id(), bid_id = 24, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project25.new_project(client_id = client10.get_id(), bid_id = 25, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
	
	project26.new_project(client_id = client6.get_id(), bid_id = 26, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project27.new_project(client_id = client7.get_id(), bid_id = 27, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project28.new_project(client_id = client8.get_id(), bid_id = 28, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project29.new_project(client_id = client9.get_id(), bid_id = 29, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project30.new_project(client_id = client10.get_id(), bid_id = 30, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
	
	project31.new_project(client_id = client6.get_id(), bid_id = 31, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project32.new_project(client_id = client7.get_id(), bid_id = 32, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project33.new_project(client_id = client8.get_id(), bid_id = 33, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project34.new_project(client_id = client9.get_id(), bid_id = 34, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project35.new_project(client_id = client10.get_id(), bid_id = 35, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
	
	project36.new_project(client_id = client6.get_id(), bid_id = 36, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project37.new_project(client_id = client7.get_id(), bid_id = 37, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project38.new_project(client_id = client8.get_id(), bid_id = 38, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project39.new_project(client_id = client9.get_id(), bid_id = 39, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project40.new_project(client_id = client10.get_id(), bid_id = 40, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
	
	project41.new_project(client_id = client6.get_id(), bid_id = 41, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project42.new_project(client_id = client7.get_id(), bid_id = 42, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project43.new_project(client_id = client8.get_id(), bid_id = 43, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project44.new_project(client_id = client9.get_id(), bid_id = 44, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project45.new_project(client_id = client10.get_id(), bid_id = 45, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
	
	project46.new_project(client_id = client6.get_id(), bid_id = 46, title = "NO", desc = "I have a lot of money", deadline = later, bid_end_date = later)
	project47.new_project(client_id = client7.get_id(), bid_id = 47, title = "MORE", desc = "I have a lot of money, too?", deadline = later, bid_end_date = later)
	project48.new_project(client_id = client8.get_id(), bid_id = 48, title = "PROJECT", desc = "I have more money than the other guy", deadline = later, bid_end_date = later)
	project49.new_project(client_id = client9.get_id(), bid_id = 49, title = "OR", desc = "Don't listen to any of them, I have the most", deadline = later, bid_end_date = later)
	project50.new_project(client_id = client10.get_id(), bid_id = 50, title = "NOT", desc = "Moo", deadline = later, bid_end_date = later)
