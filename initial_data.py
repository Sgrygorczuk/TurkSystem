...
and other notifications instead of using postal mail, email, or voicemail.''')
	...
	user1.new_user(name = "controlled", username = "controlled", password = "controlled", user_type = "dev", balance = 10, resume = resume, interests = ["data", "statistics", "AI", "computer"], status = "active")
	user2.new_user(name = "Jane Doe", username = "isa", password = 'cat', user_type = "dev", balance = 20, project_ids = [2], team_id = 2, interests = ["AI", "data", "statistics"], status = "active")
	user3.new_user(name = "Cow", username = "can", password = 'code?', user_type = "dev", balance = 30, interests = ["books", "music", "games"], status = "active")
	user4.new_user(name = "Loner", username = "Loner", password = 'in_corner', user_type = "dev", balance = 40, interests = ["news", "stocks", "money"], status = "active")
	user5.new_user(name = "Bonder", username = "1", password = '1', team_id = 0, user_type = "dev", balance = 50, interests = ["robot", "AI", "computer"], status = "active")
	user6.new_user(name = "Franker", username = "2", password = '2', team_id = 0,  user_type = "dev", balance = 60, interests = ["games", "web", "mobile", "internet"], status = "active")
	...
	client0.new_user(name = "controlled", username = "controlled", password = "controlled", user_type = "client", balance = 10, project_ids = [0], interests = ["games", "web", "AI", "internet"], status = "active")
	client1.new_user(name = "Jack Sparrow", username = "Fish", password = "cat", user_type = "client", balance = 10, project_ids = [0,1,2,3], interests = ["data", "news", "music", "AI", "stocks"], status = "active")
	client2.new_user(name = "Jasmin Tea", username = "is", password = 'awesome!', user_type = "client", balance = 20, project_ids = [2], interests = ["games", "computer", "mobile", "statistics", "stocks"], status = "active")
	client3.new_user(name = "Rick", username = "mr", password = 'meeseeks', user_type = "client", balance = 30, interests = ["data", "web", "books", "AI", "music"], status = "active")
	client4.new_user(name = "Morty", username = "rick", password = 'adventure', user_type = "client", balance = 40, interests = ["games", "money", "mobile", "AI", "robot"], status = "active")
